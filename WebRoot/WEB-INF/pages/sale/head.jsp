...
<div id="box">
	<div id="dark">
		<s:a action="cart_list" namespace="/product"><img src="${context_path}/imgsystem/index_03.gif" width="28" height="14" /> 我的购物车</s:a> | <s:a action="order_findByCustomer"	namespace="/product">我的订单</s:a>　
...
使用帮助</div>
	...
	<div id="menu">
		...
		<s:a action="product_findNewProduct" namespace="/product">
			<img src="${context_path}/imgsystem/index_13.gif" width="100" height="33" />
		</s:a>
		<s:a action="product_findSellProduct" namespace="/product">
			<img src="${context_path}/imgsystem/index_14.gif" width="99" height="33" />
		</s:a>
		<s:a action="product_findCommendProduct" namespace="/product">
			<img src="${context_path}/imgsystem/index_15.gif" width="98" height="33" />
		</s:a>
		<s:a action="product_findEnjoyProduct" namespace="/product">
